...
class DonorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donor" do
    assert_difference('Donor.count') do
      post donors_url, params: { donor: { cpf: @donor.cpf, email: @donor.email, endereco: @donor.endereco, idade: @donor.idade, nome: @donor.nome, telefone: @donor.telefone, tipo_sanguineo: @donor.tipo_sanguineo } }
    end
  ...
  test "should update donor" do
    patch donor_url(@donor), params: { donor: { cpf: @donor.cpf, email: @donor.email, endereco: @donor.endereco, idade: @donor.idade, nome: @donor.nome, telefone: @donor.telefone, tipo_sanguineo: @donor.tipo_sanguineo } }
